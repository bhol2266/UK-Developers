...
export default function Home() {
  return (
    ...
    <div className='pb-24'>
      ...
      <div className='mt-16 lg:mt-24 md:flex justify-around xl:justify-around space-y-8 md:space-y-0 md:space-x-6  lg:space-x-10   px-8 sm:mx-auto md:px-6   sm:w-fit xl:w-full'>
