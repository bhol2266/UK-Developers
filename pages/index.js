...
export default function Home() {
  return (
    <div className='px-[20px] sm:px-[26px] md:px-[30px] lg:px-[36px] xl:px-[60px] 2xl:px-[70px] '>

      <div className=' bg-banner w-full bg-no-repeat bg-cover h-[300px] lg:h-[400px] xl:h-[600px]   flex flex-col justify-start items-start  pt-[100px] md:pt-[140px] xl:pt-[160px] 2xl:pt-[180px]  md:pl-[40px] xl:pl-[100px] 2xl:pl-[200px]'>
